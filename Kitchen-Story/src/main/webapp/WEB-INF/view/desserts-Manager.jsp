		...
		<c:forEach var="desserts" items="${desserts}">
			<tr>
				...
				<td><button class="btn btn-danger"
						onclick="location.href='deleteDesserts?id=${desserts.id}'">Delete</button></td>
			</tr>
		</c:forEach>
		<tr>
			<td rowspan="2" colspan="5"><div align="center">
					<button id="add" class="btn btn-primary"
						onclick="location.href='addDesserts'">Add Desserts</button>
				</div>
			<td>
	</table>
