...
<body>
	...
	<form:form action="addedDesserts" modelAttribute="desserts"
		...
		<br>
		<div align="center">
			<input type="submit" value="Add Desserts" class="btn btn-primary"
				id="add">
		</div>
	</form:form>
</body>
