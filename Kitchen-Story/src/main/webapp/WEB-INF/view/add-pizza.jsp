...
<link rel="stylesheet" href="urlconfig/css/addpizza.css">
<link rel="stylesheet"
...
<body>
	<a href="pizzamanager"><h4 id="back">&#60Back</h4></a>
	<h1>Add Pizza</h1>
	<form:form action="addedPizza" modelAttribute="pizza" method="post">
		<table>
			<tr>
				<td><label>Pizza Name</label></td>
				<td><form:input path="name" /><br></td>
				<td><form:errors path="name" cssClass="error"></form:errors><br></td>
			</tr>
			<tr>
				<td><label>Pizza Description</label></td>
				<td><form:textarea path="desc" /><br></td>
				<td><form:errors path="desc" cssClass="error"></form:errors><br></td>
			</tr>
			<tr>
				<td><label>Pizza Price</label></td>
				<td><form:input path="price" /><br></td>
			</tr>
			<tr>
				<td><label>Pizza Image Address</label></td>
